      ...
      >
        <div className="flex flex-col items-center w-full">
          ...
          <div className="lg:max-w-[1176px] bg-white py-6 lg:py-[64px] px-8 lg:px-[123px] rounded-lg shadow-[0_-81px_50px_#0000000D]">
            <h2 className="text-3xl font-bold mb-8">Polityka prywatności & plików cookies</h2>
            ...
            <p className="mb-8">
              ...
              getbold.agency Operatorem serwisu oraz Administratorem danych osobowych jest: Dawid
              Urbas Get Bold ul. Żołnierzy Września 79/ 6, 41-500 Chorzów Adres kontaktowy poczty
              elektronicznej operatora: dawid@getbold.agency Operator jest Administratorem Twoich
              danych osobowych w odniesieniu do danych podanych dobrowolnie w Serwisie. Serwis
            ...
            <p className="mb-8">
              Serwis jest hostowany (technicznie utrzymywany) na serwerach operatora: Netlify
            </p>
            ...
            <p className="mb-8">
              ...
              przetwarzane dłużej niż przez 3 lata. <br /> Przysługuje Ci prawo żądania od
              Administratora:
              <ul className="list-disc pl-4 py-2">
              ...
              wolności, w szczególności ustalenia, dochodzenia lub obrony roszczeń. <br />
              Na działania Administratora przysługuje skarga do Prezesa Urzędu Ochrony Danych
              Osobowych, ul. Stawki 2, 00-193 Warszawa. <br />
              ...
              umowy oraz w celu prowadzenia przez Administratora marketingu bezpośredniego. <br />
            ...
            <h3 className="text-lg font-bold mb-2">5. Informacje w formularzach</h3>
            <p className="mb-8">
              Serwis zbiera informacje podane dobrowolnie przez użytkownika, w tym dane osobowe, o
              ile zostaną one podane. <br />
            ...
            <h3 className="text-lg font-bold mb-2">7. Istotne techniki marketingowe</h3>
            <p className="mb-8">
            ...
            <h3 className="text-lg font-bold mb-2">8. Informacja o plikach cookies</h3>
            <p className="mb-8">
              ...
              oraz uzyskującym do nich dostęp jest operator Serwisu. <br />
              ...
              ich usunięcia przez Użytkownika. <br />
              ...
              pomoc lub dokumentacja przeglądarki internetowej. <br />
              Ograniczenia stosowania plików cookies mogą wpłynąć na niektóre funkcjonalności
              dostępne na stronach internetowych Serwisu. <br />
            ...
            <p className="mb-8">
              ...
              utrudnić, a w skrajnych przypadkach może uniemożliwić korzystanie ze stron www. <br />
