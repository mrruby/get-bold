  ...
  return (
    <ParallaxProvider>
      <Layout
        ...
        isContactPage={false}
      >
        <div className="flex flex-col items-center w-full mt-[-600px] md:mt-[-800px]">
          ...
          <div className="lg:max-w-[1176px] bg-white py-6 lg:py-[64px] px-8 lg:px-[123px] rounded-lg shadow-[0_-81px_50px_#0000000D]">
            ...
            <p className="mb-8">
              ...
              siedzibą w 47-400 Racibórz, Ul. Mała 2. Adres kontaktowy poczty
              elektronicznej operatora: adrianna@getbold.agency Operator jest
...
export const Head = () => (
  <SEO title="Polityka prywatności & plików cookies - GetBold" />
);
