      ...
      <div className="flex flex-col items-center w-full">
        ...
        <div className="lg:max-w-[1176px] bg-white py-6 lg:py-[64px] px-8 lg:px-[123px] rounded-lg shadow-[0_-81px_50px_#0000000D]">
          ...
          <p className="mb-8">
            ...
            url: getbold.agency Operatorem serwisu oraz Administratorem danych
            osobowych jest: Dawid Urbas Get Bold ul. Żołnierzy Września 79/ 6,
            41-500 Chorzów Adres kontaktowy poczty elektronicznej operatora:
            dawid@getbold.agency Operator jest Administratorem Twoich danych
          ...
          <p className="mb-8">
            ...
            dane osobowe, o ile zostaną one podane. <br />
          ...
          <p className="mb-8">
            ...
            cookies lub do czasu ich usunięcia przez Użytkownika. <br />
            ...
            zawiera pomoc lub dokumentacja przeglądarki internetowej. <br />
          ...
          <p className="mb-8">
            ...
            przypadkach może uniemożliwić korzystanie ze stron www. <br />W celu
